...
public class ExampleStatemachine implements IExampleStatemachine {
	...
	public void runCycle() {
		...
		for (nextStateIndex = 0; nextStateIndex < stateVector.length; nextStateIndex++) {
			...
			case main_region_White:
				...
				break;
			case main_region_ItsAtRap:
				main_region_ItsAtRap_react(true);
				break;
			default:
				// $NullState$
			}
	...
	*/
	public boolean isStateActive(State state) {
		...
		case main_region_ItsAtRap:
			return stateVector[0] == State.main_region_ItsAtRap;
		default:
			return false;
		}
	}
	...
	*/
	...
	/* 'default' enter sequence for state ItsAtRap */
	private void enterSequence_main_region_ItsAtRap_default() {
		nextStateIndex = 0;
		stateVector[0] = State.main_region_ItsAtRap;
	}
	...
	/* Default exit sequence for state ItsAtRap */
	private void exitSequence_main_region_ItsAtRap() {
		nextStateIndex = 0;
		stateVector[0] = State.$NullState$;
	}
	...
	private void exitSequence_main_region() {
		...
		case main_region_White:
			...
			break;
		case main_region_ItsAtRap:
			exitSequence_main_region_ItsAtRap();
			break;
		default:
			break;
		}
				...
				if (sCInterface.black) {
					...
					if (timeEvents[0]) {
						...
						if (sCInterface.white) {
							exitSequence_main_region_Black();
							enterSequence_main_region_ItsAtRap_default();
						} else {
							did_transition = false;
						}
					}
	...
	private boolean main_region_ItsAtRap_react(boolean try_transition) {
		boolean did_transition = try_transition;
