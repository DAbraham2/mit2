...
public class ExampleStatemachine implements IExampleStatemachine {
	protected class SCInterfaceImpl implements SCInterface {
		...
		private boolean feri;
		
		public void raiseFeri() {
			feri = true;
		}
	...
	public void runCycle() {
		...
		for (nextStateIndex = 0; nextStateIndex < stateVector.length; nextStateIndex++) {
			...
			case main_region_White:
				...
				break;
			case main_region_Feri:
				main_region_Feri_react(true);
				break;
			default:
				// $NullState$
			}
	...
	*/
	public boolean isStateActive(State state) {
		...
		case main_region_Feri:
			return stateVector[0] == State.main_region_Feri;
		default:
			return false;
		}
	}
	...
	*/
	...
	/* 'default' enter sequence for state Feri */
	private void enterSequence_main_region_Feri_default() {
		nextStateIndex = 0;
		stateVector[0] = State.main_region_Feri;
	}
	...
	/* Default exit sequence for state Feri */
	private void exitSequence_main_region_Feri() {
		nextStateIndex = 0;
		stateVector[0] = State.$NullState$;
	}
	...
	private boolean main_region_Feri_react(boolean try_transition) {
		boolean did_transition = try_transition;
